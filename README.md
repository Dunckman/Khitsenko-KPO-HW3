...
**Оговорочка:** У меня были небольшие проблемы с .md файлом, т.к. при его переоткрытии сбивались отсутпы или таблицы. Однако в гитхабе вроде нормально отображается. Для подстраховки приложил README.txt с тем же md-текстом.
